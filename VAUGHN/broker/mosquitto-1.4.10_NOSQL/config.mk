...
LIB_CFLAGS:=${CFLAGS} ${CPPFLAGS} -I. -I.. -I../lib -I/usr/include/mysql -fdebug-prefix-map=/build/mysql-5.7-L3SQl5/mysql-5.7-5.7.16=. -fabi-version=2 -fno-omit-frame-pointer
#got this from mysql_config --cflags
