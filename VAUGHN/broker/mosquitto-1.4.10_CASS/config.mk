...
LIB_CFLAGS:=${CFLAGS} ${CPPFLAGS} -I. -I.. -I../lib -I/usr/local/include
...
ifneq ($(or $(findstring $(UNAME),FreeBSD), $(findstring $(UNAME),OpenBSD)),)
	BROKER_LIBS:=-lm -L/usr/local/lib/x86_64-linux-gnu -lcassandra
else
	BROKER_LIBS:=-ldl -lm -L/usr/local/lib/x86_64-linux-gnu -lcassandra
endif
LIB_LIBS:= -L/usr/local/lib/x86_64-linux-gnu -lcassandra
PASSWD_LIBS:=
