...
\begin{table}[]
	...
	\resizebox{.47\textwidth}{!}{%
		\begin{tabular}{r|c|r|r|r|}
			\cline{2-5}
			\multicolumn{1}{l|}{} & \multicolumn{4}{c|}{Data price} \\ \cline{2-5} 
			\multicolumn{1}{l|}{} & \multicolumn{2}{c|}{No Oraclize} & \multicolumn{2}{c|}{With Oraclize} \\ \hline
			\multicolumn{1}{|c|}{Data rate} & ETH & \multicolumn{1}{c|}{USD} & \multicolumn{1}{c|}{ETH} & \multicolumn{1}{c|}{USD} \\ \hline
