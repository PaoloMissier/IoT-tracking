...
\title{Towards a decentralized, trustless infrastructure for brokered data traffic metering to enable IoT data marketplaces}
...
\note{[ explain the concept of eth transactions as extension of bitcoin transaction]}

\note{[say what is a transaction in this setting -- ie between a marketplace coordinator and the settlement service, how it works in practice, how much it costs.  Traffic cube are the message payload…]}


\section{Initial proof-of-concept realisation}

\note{Proof of Concept using Eth}
